...
public class Point implements Comparable<Point> {
    ...
    public Comparator<Point> slopeOrder() {
        ...
        return new Comparator<Point>() {
            ...
            public int compare(Point o1, Point o2) {
                if (Point.this.slopeTo(o1) < Point.this.slopeTo(o2)) return -1;
                if (Point.this.slopeTo(o1) > Point.this.slopeTo(o2)) return 1;
                return 0;
            }
        };
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Negative: " + p1.slopeTo(p5));
        System.out.println("Same points: " + p1.slopeTo(p1));

        // test compareTo()
        System.out.println("Different y: " + p1.compareTo(p2));
        System.out.println("Same y: "  + p1.compareTo(p3));
        System.out.println("Same point: " + p1.compareTo(p1));
